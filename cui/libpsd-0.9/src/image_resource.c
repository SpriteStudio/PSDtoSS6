...
psd_status psd_get_image_resource(psd_context * context)
{
	...
	psd_uchar * buffer;
	psd_status status;
	psd_stream back_psdstream;	// backup psd stream data
...
/////////////////////////////////////////////////////////////////////////////////////////////
					...
					case 1050:
						...
						{
							context->stream.read_in_length	= back_psdstream.read_in_length;
							context->stream.read_out_length	= back_psdstream.read_out_length;
							context->stream.current_pos		= back_psdstream.current_pos;
							psd_stream_get_null(context, sizeofdata);
						}
						break;
